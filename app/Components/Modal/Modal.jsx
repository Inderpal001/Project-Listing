...
export default function Modal({deleteProject, handleHideModal, todos, updateTodos, updationProjectName, projectName: initialProjectName, projectId }) {
    ...
    const handleSubmitUpdateName = (updateProjectName) => {
        setUpdateName(false);
       updationProjectName(projectId, updateProjectName)
            ...
            <div className="inner-modal" onClick={(e) => e.stopPropagation()}>
                <div className="modal-heading">
                    ...
                    <div className='icon-container'>
                        {updateName ?
                            <button onClick={()=>handleSubmitUpdateName(updateProjectName)} className='todo-heading-button'>Update Name</button>
                            :
